...
public class PhilosopherWithWaiter extends Thread {
    public static Waiter waiter = new Waiter(3);
    ...
    public PhilosopherWithWaiter(int me, Fork left, Fork right) {
        this.me = me;
        this.left = left;
        this.right = right;
    }
    ...
    public static void main(String args[]) {
        ...
        PhilosopherWithWaiter p[] = new PhilosopherWithWaiter[5];
        p[0] = new PhilosopherWithWaiter(0, fork[4], fork[0]);
        for (int n = 1; n < 5; ++n) p[n] = new PhilosopherWithWaiter(n, fork[n - 1], fork[n]);
